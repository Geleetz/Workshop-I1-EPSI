...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6">
      <p class="text-center">Vous allez incarner un employé dans une entreprise sur une journée ou une semaine durant laquelle vous allez être confronté à
      ...
      <div class="d-grid gap-2 col-6 mx-auto">
        <button onclick="startGame()" type="button" class="btn btn-outline-danger">Lancer la partie</button>
      </div>
    </div>
    <div class="col-md-3"></div>
  </div>
