...
<body>
  ...
  <form>
    <!--type="submit" formaction="https://fr.w3docs.com/"-->
      <button type="button" class="btn btn-outline-danger btn-lg">Cliquez ici pour commencer!</button>
  </form>
  <div class="d-grid gap-2 col-6 mx-auto">
    <button type="button" class="btn btn-outline-danger">Cliquez ici pour commencer!</button>
  </div>
</body>
